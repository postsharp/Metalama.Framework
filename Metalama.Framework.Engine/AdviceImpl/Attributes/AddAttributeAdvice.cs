...
internal sealed class AddAttributeAdvice : Advice<AddAttributeAdviceResult>
{
        ...
        Action<ITransformation> addTransformation )
    {
            ...
            if ( existingAttribute != null )
            {
                ...
                switch ( this._overrideStrategy )
                {
                    ...
                    case OverrideStrategy.Ignore:
                        return new AddAttributeAdviceResult( AdviceOutcome.Ignore, (IRef<IAttribute>) existingAttribute.ToRef() );
        ...
        AddAttributeAdviceResult AddTransformations( AdviceOutcome outcome, RemoveAttributesTransformation? removeTransformation = null )
        {
            ...
            {
                addTransformation( new ConstructorBuilder( this, constructor.DeclaringType ) { ReplacedImplicit = constructor.ToTypedRef() }.ToTransformation() );
            }
