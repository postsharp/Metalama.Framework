...
namespace Metalama.Framework.Engine.DesignTime.Pipeline
{
    ...
    public sealed class CompilationResult : ITransitiveAspectsManifest
    {
        ...
        /// </summary>
        private readonly ImmutableDictionary<string, SyntaxTreeResult> _syntaxTreeResults = _emptySyntaxTreeResults;

        /// <summary>
        /// List of SyntaxTreeResult that have been invalidated.
        /// </summary>
        private readonly ImmutableDictionary<string, SyntaxTreeResult> _invalidSyntaxTreeResults = _emptySyntaxTreeResults;
        ...
        internal CompilationResult Update( PartialCompilation compilation, DesignTimeAspectPipelineResult pipelineResults )
        {
            ...
            foreach ( var result in resultsByTree )
            {
                     ...
                     this._invalidSyntaxTreeResults.TryGetValue( filePath, out oldSyntaxTreeResult ) )
                {
                    ...
                    {
                        introducedSyntaxTreeBuilder ??= this._introducedSyntaxTrees.ToBuilder();
        ...
        /// <returns></returns>
        private static IEnumerable<SyntaxTreeResult> SplitResultsByTree( PartialCompilation compilation, DesignTimeAspectPipelineResult pipelineResults )
        {
...
#pragma warning disable CA1822
        public CompilationResult Clear()
