...
{
    internal class EventAddRedirectionSubstitution : SyntaxNodeSubstitution
    {
        private readonly SyntaxNode _rootNode;
        private readonly IEventSymbol _targetEvent;

        public EventAddRedirectionSubstitution( SyntaxNode rootNode, IEventSymbol targetEvent )
        {
        ...
        public override SyntaxNode? Substitute( SyntaxNode currentNode, SubstitutionContext substitutionContext )
        {
            return
                Block(
                    ExpressionStatement( AssignmentExpression( SyntaxKind.AddAssignmentExpression, CreateAccessExpression(), IdentifierName( "value" ) ) ) )
