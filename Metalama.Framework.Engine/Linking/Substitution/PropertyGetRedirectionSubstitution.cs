...
{
    internal class PropertyGetRedirectionSubstitution : SyntaxNodeSubstitution
    {
        private readonly SyntaxNode _rootNode;
        private readonly IPropertySymbol _targetProperty;

        public PropertyGetRedirectionSubstitution( SyntaxNode rootNode, IPropertySymbol targetProperty )
        {
        ...
        public override SyntaxNode? Substitute( SyntaxNode currentNode, SubstitutionContext substitutionContext )
        {
            return
                Block(
                    ReturnStatement( CreateAccessExpression() ) )
