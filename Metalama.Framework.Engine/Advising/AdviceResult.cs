    ...
    where T : class, IDeclaration
{
    ...
    internal AdviceResult( IRef<T> declaration, CompilationModel compilation, AdviceOutcome outcome, IAspectBuilder aspectBuilder, AdviceKind adviceKind, IReadOnlyCollection<ImplementedInterface> interfaces, IReadOnlyCollection<ImplementedInterfaceMember> interfaceMembers )
    {
