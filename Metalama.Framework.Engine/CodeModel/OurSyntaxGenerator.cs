...
namespace Metalama.Framework.Engine.CodeModel
{
    internal class SyntaxGeneratorWithContext : OurSyntaxGenerator
    {
        ...
        {
            var constructorArguments = attribute.ConstructorArguments.Select( a => AttributeArgument( this.AttributeValueExpression( a.Value ) ) );
        ...
        public SyntaxList<AttributeListSyntax> AttributesForDeclaration( IDeclaration declaration, SyntaxKind attributeTargetKind = SyntaxKind.None )
        {
            ...
            else
            {
                ...
                {
                    var attributeList = AttributeList( SingletonSeparatedList( this.Attribute( attribute.GetTarget( declaration.Compilation ) ) ) );
