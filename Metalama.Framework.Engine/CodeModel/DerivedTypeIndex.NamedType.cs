...
namespace Metalama.Framework.Engine.CodeModel
{
    public sealed partial class DerivedTypeIndex
    {
        ...
        private readonly struct NamedType
        {
            ...
            public INamedType ToIType( CompilationModel compilationModel ) => this.IType?.Translate( compilationModel ) ?? compilationModel.Factory.GetNamedType( this.Symbol! );

            public override string? ToString() => this._value.ToString();

            public sealed class Comparer( IEqualityComparer<INamedTypeSymbol> symbolComparer, IEqualityComparer<INamedType> typeComparer ) : IEqualityComparer<NamedType>
            {
