...
{
    public sealed partial class CompilationModel : SymbolBasedDeclaration, ICompilationInternal, IHasPartialCompilation
    {
        ...
        IPartialCompilation IHasPartialCompilation.PartialCompilation => this.PartialCompilation;
