    ...
    where T : class, ICompilationElement
{
    ...
    public static readonly RefEqualityComparer<T> IncludeNullability = new(
        StructuralSymbolComparer.IncludeAssemblyAndNullability,
        StructuralDeclarationComparer.IncludeAssemblyAndNullability );

    public static RefEqualityComparer<T> GetInstance( bool includeNullability ) => includeNullability ? IncludeNullability : Default;
