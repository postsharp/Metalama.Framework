...
{
    public static DeclarationRefTargetKind ToDeclarationRefTargetKind( this MethodKind methodKind, DeclarationRefTargetKind existingTargetKind = DeclarationRefTargetKind.Default )
