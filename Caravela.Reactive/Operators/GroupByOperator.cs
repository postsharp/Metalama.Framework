...
namespace Caravela.Reactive.Operators
{
        ...
        IReactiveGroupBy<TKey, TElement>, IGroupByOperator<TKey, TElement>
    {
        ...
        private void AddItem( ref ImmutableDictionary<TKey, Group<TKey, TElement>> newResult, TSource item, in IncrementalUpdateToken updateToken )
        {
        ...
        private void RemoveItem( ref ImmutableDictionary<TKey, Group<TKey, TElement>> newResult, TSource removedItem, in IncrementalUpdateToken updateToken )
        {
