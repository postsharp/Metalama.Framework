...
namespace Metalama.Testing.Framework
{
    ...
    public class TestOptions
    {
        ...
        /// when <see cref="TestScenario"/> is set to <see cref="Metalama.Testing.Framework.TestScenario.ApplyCodeFix"/> or <see cref="Metalama.Testing.Framework.TestScenario.PreviewCodeFix"/>.
                ...
                switch ( optionName )
                {
                    ...
                    case "TestScenario":
                        if ( Enum.TryParse<TestScenario>( optionArg, out var testScenario ) )
                        {
                            ...
                            switch ( testScenario )
                            {
                                case Framework.TestScenario.PreviewLiveTemplate:
                                    this.TestRunnerFactoryType =
                                ...
                                case Framework.TestScenario.ApplyLiveTemplate:
                                    this.TestRunnerFactoryType =
                                        "Metalama.Framework.Tests.Integration.Runners.LiveTemplateTestRunnerFactory, Metalama.Framework.Tests.Integration.Internals";
