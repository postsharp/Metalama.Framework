...
namespace Caravela.Framework.Impl.Templating
{
    internal partial class TemplateAnnotator
    {
        private class ScopeContext
        {
            ...
            private ScopeContext(SymbolDeclarationScope currentScope, bool isRuntimeConditionalBlock, bool forceCompileTimeOnlyExpression, string? forceCompileTimeOnlyExpressionReason )
            {
            ...
            public static ScopeContext CreateHelperScope(SymbolDeclarationScope scope, bool isRuntimeConditionalBlock = false, bool forceCompileTimeOnlyExpression = false, string? forceCompileTimeOnlyExpressionReason = null)
            {
