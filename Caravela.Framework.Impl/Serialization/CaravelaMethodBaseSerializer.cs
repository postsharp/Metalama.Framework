...
namespace Caravela.Framework.Impl.Serialization
{
        ...
        where TOutput : MethodBase
    {
        ...
        internal ExpressionSyntax SerializeMethodBase( ICompileTimeReflectionObject<IMethodBase> method, ICompilationElementFactory syntaxFactory )
            => this.SerializeMethodBase( (IMethodSymbol) method.Target.GetSymbol( syntaxFactory.Compilation ).AssertNotNull( Justifications.SerializersNotImplementedForIntroductions ), syntaxFactory );
