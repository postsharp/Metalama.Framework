...
namespace Caravela.Framework.Impl
{
    ...
    internal static class GeneralDiagnosticDescriptors
    {
        ...
        public static readonly StrongDiagnosticDescriptor<(string Message, string File)> UncaughtException =
            new( "CR0001", "Unexpected exception in Caravela.", "Unexpected exception occurred in Caravela: {0} Exception details are in {1}.", _category, Error );

        public static readonly StrongDiagnosticDescriptor<(IType AspectType, CodeElementKind CodeElementKind, ICodeElement CodeElement, IType InterfaceType)> AspectAppliedToIncorrectElement =
            new( "CR0003", "Aspect applied to incorrect kind of element.", "Aspect '{0}' cannot be applied to {1} '{2}', because this aspect does not implement the '{3}' interface.", _category, Error );
        ...
        public static readonly StrongDiagnosticDescriptor<IMember> CannotProvideInstanceForStaticMember =
            new( "CR0014", "Cannot provide instance for a static member.", "Member {0} is static, but has been used with a non-null instance.", _category, Error );

        public static readonly StrongDiagnosticDescriptor<IMember> MustProvideInstanceForInstanceMember =
            new( "CR0015", "Has to provide instance for an instance member.", "Member {0} is not static, but has been used with a null instance.", _category, Error );
        ...
        public static readonly StrongDiagnosticDescriptor<IMember> CannotProvideInstanceForLocalFunction =
            new( "CR0018", "Cannot provide instance for a local function.", "{0} is a local function, so it Cannot be invoked with a non-null instance.", _category, Error );
        ...
        public static readonly StrongDiagnosticDescriptor<string> CycleInAspectOrdering =
            new( "CR0021", "A cycle was found in aspect ordering.", "A cycle was found in the specifications of aspect ordering between the following aspect part: {0}.", _category, Error );
