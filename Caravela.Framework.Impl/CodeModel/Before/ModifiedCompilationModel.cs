...
namespace Caravela.Framework.Impl.CodeModel
{
    ...
    internal sealed class ModifiedCompilationModel : CompilationModel
    {
        ...
        public override IReadOnlyList<IAttribute> Attributes => this._originalCompilation.Attributes;
        ...
        internal override IReadOnlyList<Transformation> CollectTransformations() => this._originalCompilation.CollectTransformations().Union( this._transformations );
