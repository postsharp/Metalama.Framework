    ...
    internal abstract class Declaration : IDeclarationInternal, IHasDiagnosticLocation
    {
        ...
        public IReadOnlyList<ISymbol> LookupSymbols()
        {
            ...
            var implicitSymbols =
                ...
                : this.Symbol switch
                {
                    IMethodSymbol { MethodKind: RoslynMethodKind.PropertySet or RoslynMethodKind.EventAdd or RoslynMethodKind.EventRemove } methodSymbol => methodSymbol.Parameters,
