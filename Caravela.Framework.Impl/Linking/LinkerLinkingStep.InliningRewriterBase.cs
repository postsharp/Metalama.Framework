...
namespace Caravela.Framework.Impl.Linking
{
    internal partial class LinkerLinkingStep
    {
        ...
        private abstract class InliningRewriterBase : CSharpSyntaxRewriter
        {
            ...
            protected static ExpressionSyntax GetImplicitBackingFieldAccessExpression( IPropertySymbol property )
            {
                if ( property.IsStatic )
                {
                    // TODO: Full qualification of the current type?
                    return IdentifierName( LinkingRewriter.GetImplicitBackingFieldName( property ) );
                }
                else
                {
