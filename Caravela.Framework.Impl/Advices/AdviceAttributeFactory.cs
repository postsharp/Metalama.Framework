                        ...
                        switch ( templateDeclaration )
                        {
                            case IMethod templateMethod:
                                var introduceMethodAdvice = new IntroduceMethodAdvice(
                                    aspect,
                                    targetType,
                                    new Template<IMethod>( templateMethod, TemplateKind.Introduction ),
                                    scope,
                                    conflictBehavior,
                                    layerName,
                                    null );
                            ...
                            case IProperty templateProperty:
                                var introducePropertyAdvice = new IntroducePropertyAdvice(
                                    ...
                                    targetType,
                                    null,
                                    new Template<IProperty>( templateProperty, TemplateKind.Introduction ),
                                    default,
                                    default,
                                    scope,
                                    conflictBehavior,
                            ...
                            case IEvent templateEvent:
                                var introduceEventAdvice = new IntroduceEventAdvice(
                                    ...
                                    targetType,
                                    null,
                                    new Template<IEvent>( templateEvent, TemplateKind.Introduction ),
                                    default,
                                    default,
                                    scope,
                                    conflictBehavior,
                            ...
                            case IField templateField:
                                var introduceFieldAdvice = new IntroduceFieldAdvice(
                                    ...
                                    targetType,
                                    null,
                                    new Template<IField>( templateField, TemplateKind.Introduction ),
                                    scope,
                                    conflictBehavior,
                                    layerName );
