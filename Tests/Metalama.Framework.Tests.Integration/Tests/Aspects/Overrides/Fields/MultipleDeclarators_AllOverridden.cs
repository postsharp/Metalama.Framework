...
namespace Metalama.Framework.IntegrationTests.Aspects.Overrides.Fields.MultipleDeclarators_AllOverridden
{
    public class TestAttribute : TypeAspect
    {
        ...
        {
            builder.Advices.Override( builder.Target.Fields.OfName( "A" ).Single(), nameof(PropertyTemplate) );
            builder.Advices.Override( builder.Target.Fields.OfName( "B" ).Single(), nameof(PropertyTemplate) );
            builder.Advices.Override( builder.Target.Fields.OfName( "C" ).Single(), nameof(PropertyTemplate) );
        }
