...
namespace Metalama.Framework.Tests.Integration.TestInputs.Aspects.Overrides.Properties.MethodGetTemplate
{
    ...
    public class OverrideAttribute : FieldOrPropertyAspect
    {
        ...
        {
            builder.Advices.OverrideFieldOrPropertyAccessors( builder.Target, nameof(GetProperty) );
        }
