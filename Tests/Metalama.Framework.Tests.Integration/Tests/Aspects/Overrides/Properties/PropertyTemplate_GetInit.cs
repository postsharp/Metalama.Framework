...
namespace Metalama.Framework.Tests.Integration.TestInputs.Aspects.Overrides.Properties.PropertyTemplate_GetInit
{
    // Tests single OverrideProperty aspect on get&init properties.
