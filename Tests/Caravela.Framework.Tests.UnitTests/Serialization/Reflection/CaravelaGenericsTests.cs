    ...
    public class CaravelaGenericsTests : ReflectionTestBase
    {
        ...
        public void TestDerivedGenericType()
        {
            ...
            var serialized2 = this._objectSerializers
                                  .SerializeToRoslynCreationExpression(
                                      CompileTimeType.Create( CreateCompilation( code ).DeclaredTypes.Single( t => t.Name == "Target" ) ) )
                                  .ToString();
        ...
        public void TestHalfTypes()
        {
            ...
            var serialized = this._objectSerializers.SerializeToRoslynCreationExpression(
                                     CompileTimeMethodInfo.Create(
                                         CreateCompilation( code ).DeclaredTypes.Single( t => t.Name == "User" ).BaseType!.Methods.First() ) )
                                 .ToString();
            ...
            var serialized2 = this._objectSerializers.SerializeToRoslynCreationExpression(
                                      CompileTimeMethodInfo.Create(
                                          CreateCompilation( code2 ).DeclaredTypes.Single( t => t.Name == "User" ).BaseType!.Methods.First() ) )
                                  .ToString();
