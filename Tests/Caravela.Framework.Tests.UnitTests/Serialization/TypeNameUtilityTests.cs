    ...
    public class TypeNameUtilityTests
    {
        ...
        public void TestTypeNameUtility()
        {
            var typesToTest = new Dictionary<string, Type>
            {
                ...
                { "System.Collections.Generic.Dictionary<Caravela.Framework.Tests.UnitTests.Serialization.TestClass, Caravela.Framework.Tests.UnitTests.Serialization.TestClass>", typeof( Dictionary<TestClass, TestClass> ) },
                { "System.Collections.Generic.Dictionary<System.String, Caravela.Framework.Tests.UnitTests.Serialization.TestClass>", typeof( Dictionary<string, TestClass> ) },
                { "System.Collections.Generic.List<System.Collections.Generic.Dictionary<System.String, Caravela.Framework.Tests.UnitTests.Serialization.TestClass>>", typeof( List<Dictionary<string, TestClass>> ) },
                { "System.Collections.Generic.List<System.Collections.Generic.Dictionary<System.String, Caravela.Framework.Tests.UnitTests.Serialization.GenericTestClass<System.String>>>", typeof( List<Dictionary<string, GenericTestClass<string>>> ) },
                { "Caravela.Framework.Tests.UnitTests.Serialization.GenericTestClass<System.String>.SecondSubType<System.Decimal>", typeof( GenericTestClass<string>.SecondSubType<decimal> ) },
                { "Caravela.Framework.Tests.UnitTests.Serialization.GenericTestClass<System.String>.SecondSubType", typeof( GenericTestClass<string>.SecondSubType ) },
                { "Caravela.Framework.Tests.UnitTests.Serialization.GenericTestClass<System.String, System.Int32>.SecondSubType", typeof( GenericTestClass<string, int>.SecondSubType ) },
                { "Caravela.Framework.Tests.UnitTests.Serialization.GenericTestClass<System.String, System.Collections.Generic.Dictionary<System.String, System.Int32>>.SecondSubType<System.String>", typeof( GenericTestClass<string, Dictionary<string, int>>.SecondSubType<string> ) },
                { "Caravela.Framework.Tests.UnitTests.Serialization.GenericTestClass<System.String, System.Collections.Generic.Dictionary<System.String, System.Int32>>.SecondSubType<Caravela.Framework.Tests.UnitTests.Serialization.GenericTestClass<System.String, System.Collections.Generic.Dictionary<System.String, System.Int32>>>", typeof( GenericTestClass<string, Dictionary<string, int>>.SecondSubType<GenericTestClass<string, Dictionary<string, int>>> ) }
            };
