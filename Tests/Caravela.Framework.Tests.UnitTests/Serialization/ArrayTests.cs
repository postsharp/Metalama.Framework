...
namespace Caravela.Framework.Tests.UnitTests.Serialization
{
    public class ArrayTests
    {
        ...
        public void TestBasicArray()
        {
            ...
            this.AssertSerialization( "new Caravela.Framework.Tests.UnitTests.Serialization.Mars.Moon[]{Caravela.Framework.Tests.UnitTests.Serialization.Mars.Moon.Deimos}", new[] { Mars.Moon.Deimos } );
        }
