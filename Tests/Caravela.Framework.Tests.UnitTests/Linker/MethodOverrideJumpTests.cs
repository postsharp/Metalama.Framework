...
{
    public class MethodOverrideJumpTests : LinkerTestBase
    {
        [Fact]
...
";
        ...
        [Fact]
        public void ReturnsVoid_FJ_NJ_FJ()
        {
            var code = @"
class T
{
    ...
    [PseudoOverride(Foo, TestAspect3)]
...
";
        ...
        [Fact]
        public void ReturnsInt_Expression()
        {
            var code = @"
class T
{
    ...
    [PseudoOverride(Foo, TestAspect)]
    int Foo_Override(int x) => link(this.Foo, inline)(x);
}
";
