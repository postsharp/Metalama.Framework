...
using Caravela.Framework.IntegrationTests.Aspects.Invokers.Properties.AdvisedIntroduction_FinalInvoker;
using System.Linq;

[assembly: AspectOrder(typeof(TestAttribute), typeof(TestIntroductionAttribute))]

namespace Caravela.Framework.IntegrationTests.Aspects.Invokers.Properties.AdvisedIntroduction_FinalInvoker
{
    ...
    public class TestAttribute : Attribute, IAspect<INamedType>
    {
        ...
        {
            builder.AdviceFactory.OverrideFieldOrProperty(builder.Target.Properties.OfName(nameof(TestIntroductionAttribute.Property)).Single(), nameof(PropertyTemplate));
        }
