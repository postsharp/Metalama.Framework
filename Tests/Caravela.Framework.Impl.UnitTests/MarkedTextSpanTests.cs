...
namespace Caravela.Framework.Impl.UnitTests
{
    public class MarkedTextSpanTests
    {
        ...
        {
            TextSpanClassifier c = new TextSpanClassifier();
            c.Mark( new TextSpan( 0, 10 ), TextSpanCategory.Keyword );
        ...
        public void TwoSpans_Disjoint()
        {
            TextSpanClassifier c = new TextSpanClassifier();
            c.Mark( new TextSpan( 0, 10 ), TextSpanCategory.Keyword );
            c.Mark( new TextSpan( 15, 10 ), TextSpanCategory.Keyword );
        ...
        {
            TextSpanClassifier c = new TextSpanClassifier();
            c.Mark( new TextSpan( 0, 10 ), TextSpanCategory.Variable );
            c.Mark( new TextSpan( 5, 10 ), TextSpanCategory.Keyword );
        ...
        {
            TextSpanClassifier c = new TextSpanClassifier();
            c.Mark( new TextSpan( 5, 10 ), TextSpanCategory.Variable );
            c.Mark( new TextSpan( 0, 20 ), TextSpanCategory.Keyword );
        ...
        {
            TextSpanClassifier c = new TextSpanClassifier();
            c.Mark( new TextSpan( 10, 10 ), TextSpanCategory.Variable );
            c.Mark( new TextSpan( 12, 3 ), TextSpanCategory.Keyword );
        ...
        public void TwoSpans_Subset_LeftAligned()
        {
            TextSpanClassifier c = new TextSpanClassifier();
            c.Mark( new TextSpan( 10, 10 ), TextSpanCategory.Variable );
            c.Mark( new TextSpan( 10, 3 ), TextSpanCategory.Keyword );
        ...
        public void TwoSpans_Subset_RightAligned()
        {
            TextSpanClassifier c = new TextSpanClassifier();
            c.Mark( new TextSpan( 10, 10 ), TextSpanCategory.Variable );
            c.Mark( new TextSpan( 17, 3 ), TextSpanCategory.Keyword );
