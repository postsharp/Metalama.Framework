...
namespace Caravela.Framework.Impl.UnitTests.Templating.Serialization.Reflection
{
    public class CaravelaStateMachineTests : ReflectionTestBase
    {
        ...
        public void TestEnumerable()
        {
            ...
            var serialized = this._objectSerializers.SerializeToRoslynCreationExpression( CompileTimeMethodInfo.Create( CreateCompilation( code ).DeclaredTypes.Single( t => t.Name == "Target" ).Methods.First() ) ).ToString();
