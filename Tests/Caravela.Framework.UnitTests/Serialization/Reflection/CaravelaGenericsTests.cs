...
namespace Caravela.Framework.UnitTests.Templating.Serialization.Reflection
{
    public class CaravelaGenericsTests : ReflectionTestBase
    {
        ...
        public void MethodInDerivedType()
        {
            ...
            var serialized = this._objectSerializers.SerializeToRoslynCreationExpression( CompileTimeMethodInfo.Create( CreateCompilation( code ).DeclaredTypes.Single( t => t.Name == "Target" ).Methods.First() ) )
                .ToString();
        ...
        public void TestDerivedGenericType()
        {
            ...
            var serialized = this._objectSerializers.SerializeToRoslynCreationExpression( CompileTimeType.Create( CreateCompilation( code ).DeclaredTypes.Single( t => t.Name == "User" ).BaseType! ) )
                .ToString();
            TestExpression<Type>( code, serialized, ( info ) => Assert.Equal( "Target`1[T2]", info.ToString() ) );
            var serialized2 = this._objectSerializers.SerializeToRoslynCreationExpression( CompileTimeType.Create( CreateCompilation( code ).DeclaredTypes.Single( t => t.Name == "Target" ) ) )
                .ToString();
        ...
        public void TestHalfTypes()
        {
            ...
            var serialized = this._objectSerializers.SerializeToRoslynCreationExpression( CompileTimeMethodInfo.Create( CreateCompilation( code ).DeclaredTypes.Single( t => t.Name == "User" ).BaseType!.Methods.First() ) )
                .ToString();
            ...
            var serialized2 = this._objectSerializers.SerializeToRoslynCreationExpression( CompileTimeMethodInfo.Create( CreateCompilation( code2 ).DeclaredTypes.Single( t => t.Name == "User" ).BaseType!.Methods.First() ) )
                .ToString();
