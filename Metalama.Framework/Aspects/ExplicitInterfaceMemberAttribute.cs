...
/// <summary>
/// Custom attribute that, when applied to a member of an aspect class, means that this aspect member is a template explicitly implementing a member of an interface implemented by
