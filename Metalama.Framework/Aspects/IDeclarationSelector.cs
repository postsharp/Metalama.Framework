    ...
    where TTarget : class, IDeclaration
{
    ...
    ///  <see cref="IDeclarationSelection{TDeclaration}.AddAnnotation{TAspect,TAnnotation}"/>,  <see cref="IDeclarationSelection{TDeclaration}.RegisterDeclarationValidator"/>
