...
public readonly struct SourceReference
{
    ...
    internal SourceReference( object nodeOrToken, ISyntaxReferenceImpl syntaxReferenceImpl )
    {
    ...
    /// </summary>
    public bool IsImplementationPart => this._syntaxReferenceImpl.IsImplementationPart( this );
    ...
    /// </summary>
    public SourceSpan Span => this._syntaxReferenceImpl.GetSourceSpan( this );
    ...
    public string GetText( bool normalized = false ) => this._syntaxReferenceImpl.GetText( this, normalized );
