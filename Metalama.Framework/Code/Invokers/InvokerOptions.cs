...
public enum InvokerOptions
{
    ...
    /// <summary>
    /// Causes the <c>base</c> implementation to be called, i.e. the latest implementation of the base class.
    /// </summary>
    Base = 1,
    
    /// <summary>
    /// Causes the <i>final</c> implementation to be called, i.e. the implementation after all overrides by aspects
