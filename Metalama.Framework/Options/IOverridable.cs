...
public interface IOverridable
{
    ...
    /// </summary>
    /// <param name="other">The overriding objects, which property values, if they are set, take precedence
    ...
    object OverrideWith( object other, in OverrideContext context );
}