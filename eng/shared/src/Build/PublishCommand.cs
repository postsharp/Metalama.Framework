...
namespace PostSharp.Engineering.BuildTools.Build
{
    ...
    {
        [Description( "Sets the build configuration (Debug or Release) to publish. This option is irrelevant unless the artifact paths depend on the build configuration." )]
    ...
    {
        protected override bool ExecuteCore( BuildContext context, PublishOptions options ) 
            => context.Product.Publish( context, options );
    }
}