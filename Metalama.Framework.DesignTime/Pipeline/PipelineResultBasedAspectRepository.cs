...
internal sealed class PipelineResultBasedAspectRepository : AspectRepository
{
    ...
    public override bool HasAspect( IDeclaration declaration, Type aspectType )
    {
        ...
        return syntaxTreeResult.AspectInstances.Any( a => (a.AspectClassFullName == aspectFullName || descentantClassesNames.Contains( a.AspectClassFullName )) && a.TargetDeclarationId == declarationId );
    }
