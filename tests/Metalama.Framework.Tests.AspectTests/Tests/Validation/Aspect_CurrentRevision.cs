...
using Metalama.Framework.Tests.AspectTests.Validation.Aspect_CurrentRevision;
...
namespace Metalama.Framework.Tests.AspectTests.Validation.Aspect_CurrentRevision
{
