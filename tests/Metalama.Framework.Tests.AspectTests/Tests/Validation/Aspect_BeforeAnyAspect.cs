...
using Metalama.Framework.Tests.AspectTests.Validation.Aspect_BeforeAnyAspect;
...
namespace Metalama.Framework.Tests.AspectTests.Validation.Aspect_BeforeAnyAspect
{
