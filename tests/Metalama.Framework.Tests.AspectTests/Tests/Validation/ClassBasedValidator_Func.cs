...
namespace Metalama.Framework.Tests.AspectTests.Tests.Validation.ClassBasedValidator_Func;
...
public class Fabric : ProjectFabric
{
    ...
    {
        amender.SelectMany( p => p.Types ).ValidateInboundReferences( t => new TheValidator() );
    }
}
