...
using Metalama.Framework.Tests.AspectTests.Validation.Aspect_AfterAllAspects;
using Metalama.Framework.Validation;

#pragma warning disable CS0168, CS8618, CS0169

[assembly: AspectOrder( AspectOrderDirection.RunTime, typeof(ValidateAspect), typeof(IntroduceAspect) )]

namespace Metalama.Framework.Tests.AspectTests.Validation.Aspect_AfterAllAspects
{
