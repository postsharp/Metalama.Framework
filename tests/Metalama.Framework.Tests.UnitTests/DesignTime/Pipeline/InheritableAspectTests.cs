...
";
            ...
            Assert.Equal( new[] { "Aspect" }, compilationResult1!.AspectPipelineResult.InheritableAspectTypes.ToArray() );

            Assert.Equal(
                new[] { "T:I" },
                compilationResult1.AspectPipelineResult.GetInheritableAspects( "Aspect" ).Select( i => i.TargetDeclaration.ToSerializableId().Id ).ToArray() );
        }
...
";
            ...
            Assert.Equal(
                new[] { "T:C", "T:I" },
                compilationResult2!.AspectPipelineResult.GetInheritableAspects( "Aspect" )
            ...
            Assert.Equal(
                new[] { "T:C" },
                compilationResult3!.AspectPipelineResult.GetInheritableAspects( "Aspect" )
                    .Select( i => i.TargetDeclaration.ToSerializableId().Id )
                    .OrderBy( a => a )
                    .ToArray() );
        }
...
";
            ...
            Assert.Single( compilationResult2!.AspectPipelineResult.IntroducedSyntaxTrees );
        }
    }
}