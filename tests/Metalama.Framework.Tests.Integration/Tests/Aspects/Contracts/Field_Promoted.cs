...
using Metalama.Framework.Tests.Integration.Tests.Aspects.Contracts.Field_Promoted;
...
namespace Metalama.Framework.Tests.Integration.Tests.Aspects.Contracts.Field_Promoted
{
    /*
