...
using Metalama.Framework.Tests.Integration.TestInputs.Aspects.Introductions.Interfaces.Hierarchy;
using System;
...
namespace Metalama.Framework.Tests.Integration.TestInputs.Aspects.Introductions.Interfaces.Hierarchy
{
    /*
