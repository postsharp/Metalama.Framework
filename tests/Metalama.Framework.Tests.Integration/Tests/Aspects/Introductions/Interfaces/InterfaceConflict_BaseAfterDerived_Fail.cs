...
namespace Metalama.Framework.Tests.Integration.TestInputs.Aspects.Introductions.Interfaces.InterfaceConflict_BaseAfterDerived_Fail
{
    ...
    public class IntroductionAttribute : TypeAspect
    {
        ...
        {
            aspectBuilder.Advise.ImplementInterface( aspectBuilder.Target, typeof(IDerivedInterface) );
            aspectBuilder.Advise.ImplementInterface( aspectBuilder.Target, typeof(IBaseInterface), OverrideStrategy.Fail );
        }
