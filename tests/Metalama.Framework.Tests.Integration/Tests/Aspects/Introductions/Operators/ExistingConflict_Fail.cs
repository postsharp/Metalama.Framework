...
namespace Metalama.Framework.IntegrationTests.Aspects.Introductions.Operators.ExistingConflict_Fail
{
    public class IntroductionAttribute : TypeAspect
    {
        public override void BuildAspect(IAspectBuilder<INamedType> builder)
        {
            ...
            builder.Advice.IntroduceBinaryOperator(builder.Target, nameof(BinaryOperatorTemplate), builder.Target, builder.Target, builder.Target, OperatorKind.Addition);
