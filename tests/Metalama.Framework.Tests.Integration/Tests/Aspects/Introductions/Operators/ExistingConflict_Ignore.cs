...
namespace Metalama.Framework.IntegrationTests.Aspects.Introductions.Operators.ExistingConflict_Ignore
{
    public class IntroductionAttribute : TypeAspect
    {
        ...
        {
            builder.Advice.IntroduceUnaryOperator(builder.Target, nameof(UnaryOperatorTemplate), builder.Target, builder.Target, OperatorKind.UnaryNegation, whenExists: OverrideStrategy.Ignore);
            builder.Advice.IntroduceBinaryOperator(builder.Target, nameof(BinaryOperatorTemplate), builder.Target, builder.Target, builder.Target, OperatorKind.Addition, whenExists: OverrideStrategy.Ignore);
            builder.Advice.IntroduceConversionOperator(builder.Target, nameof(ConversionOperatorTemplate), TypeFactory.GetType(typeof(int)), builder.Target, whenExists: OverrideStrategy.Ignore);
        }
