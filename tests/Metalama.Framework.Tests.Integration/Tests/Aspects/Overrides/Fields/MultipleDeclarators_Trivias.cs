...
namespace Metalama.Framework.IntegrationTests.Aspects.Overrides.Fields.Issue30183
{
    ...
    public class TestAttribute : TypeAspect
    {
        ...
        {
            builder.Advise.Override( builder.Target.Fields.OfName( "E" ).Single(), nameof(PropertyTemplate) );
            builder.Advise.Override( builder.Target.Fields.OfName( "G" ).Single(), nameof(PropertyTemplate) );
            builder.Advise.Override( builder.Target.Fields.OfName( "H" ).Single(), nameof(PropertyTemplate) );
            builder.Advise.Override( builder.Target.Fields.OfName( "I" ).Single(), nameof(PropertyTemplate) );
        }
