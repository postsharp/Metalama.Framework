...
[assembly: AspectOrder(typeof(AddAttributeAspect), typeof(IntroducingAspect), typeof(TypeIntroducingAspect))]
...
internal class TypeIntroducingAspect : TypeAspect
{
    ...
    {
        var result = builder.Advice.IntroduceType(builder.Target, "TestType", TypeKind.Class);
