#if TEST_OPTIONS
// @RequiredConstant(NET48) - Slight differences in .NET Framework 4.8 due to nullability annotations
#endif
...
using Metalama.Framework.Tests.Integration.Tests.Aspects.Misc.Net48_Introduce_BuildReflection_NotNull;

[assembly: AspectOrder( typeof(Verification), typeof(Introduction) )]

namespace Metalama.Framework.Tests.Integration.Tests.Aspects.Misc.Net48_Introduce_BuildReflection_NotNull
{
