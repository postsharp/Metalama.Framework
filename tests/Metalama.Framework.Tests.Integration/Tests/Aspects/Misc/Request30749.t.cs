public class OrderAsyncResponseProcessor<TCommand> : BaseProcessor where TCommand : OrderCommand
{
    ...
    protected override async Task HandleFailureAsync(object response, object context)
    {
        ...
        __metalama_result.Append("Metalama.Framework.Tests.Integration.Tests.Aspects.Misc.Request30749.OrderAsyncResponseProcessor<TCommand>");
        ...
        __metalama_result.Append("}");
        __metalama_result.Append(")");
        global::Metalama.Framework.Tests.Integration.Tests.Aspects.Misc.Request30749.ParamsStacks.Push(__metalma_currentThreadId, __metalama_result.ToString());
        try
        {
        ...
        {
            global::Metalama.Framework.Tests.Integration.Tests.Aspects.Misc.Request30749.ParamsStacks.Pop(__metalma_currentThreadId);
        }
    }
