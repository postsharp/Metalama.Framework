public class OrderAsyncResponseProcessor<TCommand> : AsyncResponseProcessor<Response, TCommand> where TCommand : OrderCommand
{
  ...
  protected override async Task HandleFailureAsync(OrderResponse response, ICommandExecutionContext context)
  {
    ...
    __metalama_result.Append("Metalama.Framework.Tests.Integration.Tests.Aspects.Bugs.Bug30840.OrderAsyncResponseProcessor<TCommand>");
    ...
    __metalama_result.Append("}");
    __metalama_result.Append(")");
    global::Metalama.Framework.Tests.Integration.Tests.Aspects.Bugs.Bug30840.ParamsStacks.Push(__metalma_currentThreadId, __metalama_result.ToString());
    try
    {
    ...
    {
      global::Metalama.Framework.Tests.Integration.Tests.Aspects.Bugs.Bug30840.ParamsStacks.Pop(__metalma_currentThreadId);
    }
  }
