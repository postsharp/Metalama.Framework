...
// Warning LAMA0282 on ``: `The aspect 'TheAspect' uses features of C# 11.0, but it is used in a project built with C# 10.0. Consider specifying <LangVersion>11.0</LangVersion> in this project or removing newer language features from the template 'TheAspect.Property2.get' and then specifying <MetalamaTemplateLanguageVersion> in the aspect project.`
// Warning LAMA0282 on ``: `The aspect 'TheAspect' uses features of C# 11.0, but it is used in a project built with C# 10.0. Consider specifying <LangVersion>11.0</LangVersion> in this project or removing newer language features from the template 'TheAspect.Property2.set' and then specifying <MetalamaTemplateLanguageVersion> in the aspect project.`
