...
using System;
using System.Linq;
using Metalama.Framework.Tests.Integration.Tests.Aspects.Initialize.SecondaryInstancesOrdering;

// Tests that secondary instances are sorted propertly according to the declaration depth.

[assembly: MyAspect( "Assembly" )]

namespace Metalama.Framework.Tests.Integration.Tests.Aspects.Initialize.SecondaryInstancesOrdering;
