...
public class Override : TypeAspect
{
    ...
    {
        _ = meta.Target.Type.Properties.OfName( "AutoProperty" ).Single().GetValue( meta.This );
        meta.Target.Type.Properties.OfName( "AutoProperty" ).Single().SetValue( meta.This, 42 );
        _ = meta.Target.Type.Properties.OfName( "AutoProperty_Static" ).Single().GetValue( null );
        meta.Target.Type.Properties.OfName( "AutoProperty_Static" ).Single().SetValue( null, 42 );
        _ = meta.Target.Type.Properties.OfName( "AutoProperty_NoOverride" ).Single().GetValue( meta.This );
        meta.Target.Type.Properties.OfName( "AutoProperty_NoOverride" ).Single().SetValue( meta.This, 42 );
        _ = meta.Target.Type.Properties.OfName( "AutoProperty_Static_NoOverride" ).Single().GetValue( null );
        meta.Target.Type.Properties.OfName( "AutoProperty_Static_NoOverride" ).Single().SetValue( null, 42 );
    }
}
