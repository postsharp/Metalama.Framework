...
using Metalama.Framework.Tests.Integration.Tests.Aspects.Invokers.Fields.Field_BaseInvoker;

[assembly: AspectOrder( typeof(After), typeof(Test), typeof(Before) )]

namespace Metalama.Framework.Tests.Integration.Tests.Aspects.Invokers.Fields.Field_BaseInvoker;
...
public class After : TypeAspect
{
    ...
    public void IntroducedAfter()
    {
        ...
        _ = meta.Target.Type.Fields.OfName( "Field_Static" ).Single().With( InvokerOptions.Base ).Value;
        meta.Target.Type.Fields.OfName( "Field_Static" ).Single().With( InvokerOptions.Base ).Value = 42;
        _ = meta.Target.Type.Fields.OfName("IntroducedField").Single().With(InvokerOptions.Base).Value;
        meta.Target.Type.Fields.OfName("IntroducedField").Single().With(InvokerOptions.Base).Value = 42;
        _ = meta.Target.Type.Fields.OfName("IntroducedField_Static").Single().With(InvokerOptions.Base).Value;
        meta.Target.Type.Fields.OfName("IntroducedField_Static").Single().With(InvokerOptions.Base).Value = 42;
    }
}
