...
using Metalama.Framework.Tests.Integration.Tests.Aspects.Invokers.Fields.PromotedField_FinalInvoker;

[assembly: AspectOrder( typeof(After), typeof(Test), typeof(Before) )]

namespace Metalama.Framework.Tests.Integration.Tests.Aspects.Invokers.Fields.PromotedField_FinalInvoker;
...
public class After : TypeAspect
{
    ...
    public void IntroducedAfter()
    {
        ...
        _ = meta.Target.Type.Properties.OfName("IntroducedField").Single().With(InvokerOptions.Final).Value;
        meta.Target.Type.Properties.OfName("IntroducedField").Single().With(InvokerOptions.Final).Value = 42;
        _ = meta.Target.Type.Properties.OfName("IntroducedField_Static").Single().With(InvokerOptions.Final).Value;
        meta.Target.Type.Properties.OfName("IntroducedField_Static").Single().With(InvokerOptions.Final).Value = 42;
    }
}
