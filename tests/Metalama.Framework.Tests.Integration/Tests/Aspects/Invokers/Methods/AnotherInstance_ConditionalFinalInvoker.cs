...
namespace Metalama.Framework.IntegrationTests.Aspects.Invokers.Events.AnotherInstance_ConditionalFinalInvoker
{
    ...
    public class TestAttribute : TypeAspect
    {
        ...
        public dynamic? OverrideMethod()
        {
            ...
            {
                return meta.Target.Method.GetInvoker( InvokerOptions.NullConditional ).Invoke( x );
            }
            else
            {
                return meta.Target.Method.GetInvoker( InvokerOptions.NullConditional ).Invoke( x, meta.Target.Method.Parameters[0].Value );
            }
        }
    }
