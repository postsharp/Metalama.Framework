...
namespace Metalama.Framework.Tests.Integration.Tests.Aspects.Invokers.Methods.BaseClassVirtual_HiddenByVirtual;
...
{
    public new virtual void TargetMethod(string arg)
    {
        Console.WriteLine($"New Virtual: {arg}");
    }
