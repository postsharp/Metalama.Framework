...
using Metalama.Framework.Tests.Integration.Tests.Aspects.Invokers.Events.CallerMemberAttribute;
using System;

[assembly: AspectOrder(AspectOrderDirection.CompileTime, typeof(OverrideAspect), typeof(InvokerAspect))]

namespace Metalama.Framework.Tests.Integration.Tests.Aspects.Invokers.Events.CallerMemberAttribute;
