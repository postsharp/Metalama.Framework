    ...
    public class IntroductionAttribute : TypeAspect
    {
        ...
        public event EventHandler BaseClassEvent
        {
            add
            {
                ...
                meta.Target.Event.With( Code.Invokers.InvokerOptions.Final ).Add( meta.Target.Parameters[0].Value );
            }

            remove
            {
                Console.WriteLine( "This is introduced event." );
                meta.Target.Event.With(Code.Invokers.InvokerOptions.Final).Remove(  meta.Target.Parameters[0].Value );
            }
        }
