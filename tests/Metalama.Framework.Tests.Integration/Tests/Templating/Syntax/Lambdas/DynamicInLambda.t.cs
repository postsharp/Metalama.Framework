...
// Error LAMA0263 on `p => p.Value`: `Lambdas or anonymous functions returning a dynamic type are not supported except. Consider casting the result to IExpression.`
