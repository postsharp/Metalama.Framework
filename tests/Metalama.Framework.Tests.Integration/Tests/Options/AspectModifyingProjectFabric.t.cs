// Warning CS8618 on `E`: `Non-nullable event 'E' must contain a non-null value when exiting constructor. Consider declaring the event as nullable.`
...
public class C2
{
    ...
    {
        [OptionsAspect]
        [global::Metalama.Framework.Tests.Integration.Tests.Options.ActualOptionsAttribute("FromFabric.Project")]
        public void M([OptionsAspect][global::Metalama.Framework.Tests.Integration.Tests.Options.ActualOptionsAttribute("FromFabric.Project")] int p)
        {
        }
    }
}
