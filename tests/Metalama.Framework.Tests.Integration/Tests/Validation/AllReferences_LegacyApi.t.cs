...
// Warning MY001 on `ValidatedClass`: `Reference constraint of type 'MemberType, NullableType' to type 'ValidatedClass' from field 'DerivedClass._field1' (SyntaxKind=IdentifierName).`
...
// Warning MY001 on `ValidatedClass`: `Reference constraint of type 'MemberType, NullableType' to type 'ValidatedClass' from property 'DerivedClass.Property' (SyntaxKind=IdentifierName).`
...
// Warning MY001 on `ValidatedClass`: `Reference constraint of type 'BaseType, TypeArgument' to type 'ValidatedClass' from type 'ListOfValidated' (SyntaxKind=IdentifierName).`
