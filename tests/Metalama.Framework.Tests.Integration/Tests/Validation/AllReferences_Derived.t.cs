...
// Warning MY001 on `DerivedClass.Method`: `Reference constraint of type 'Invocation' in declaration 'ReferencingClass.ReferencingMethod()' (SyntaxKind=SimpleMemberAccessExpression).`
...
// Warning MY001 on `DerivedClass`: `Reference constraint of type 'TypeArgument, LocalVariableType' in declaration 'ReferencingClass.ReferencingMethod()' (SyntaxKind=IdentifierName).`
