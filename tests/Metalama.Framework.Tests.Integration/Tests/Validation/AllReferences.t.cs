...
// Warning MY001 on `ValidatedClass`: `Reference constraint of type 'MemberType' in declaration 'DerivedClass._field1' (SyntaxKind=IdentifierName).`
...
// Warning MY001 on `ValidatedClass`: `Reference constraint of type 'MemberType' in declaration 'DerivedClass.Property' (SyntaxKind=IdentifierName).`
// Warning MY001 on `ValidatedDelegate`: `Reference constraint of type 'MemberType' in declaration 'DerivedClass.FieldLikeEvent' (SyntaxKind=IdentifierName).`
