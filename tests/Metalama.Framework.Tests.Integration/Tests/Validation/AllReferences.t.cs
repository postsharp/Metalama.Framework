...
// Warning MY001 on `ValidatedClass`: `Reference constraint of type 'AttributeType' in declaration 'AttributeTargets.Property.get' (SyntaxKind=IdentifierName).`

// Warning MY001 on `ValidatedClass`: `Reference constraint of type 'AttributeType' in declaration 'AttributeTargets.Property.set' (SyntaxKind=IdentifierName).`

// Warning MY001 on `ValidatedClass`: `Reference constraint of type 'AttributeType' in declaration 'AttributeTargets.Method(int)' (SyntaxKind=IdentifierName).`

// Warning MY001 on `ValidatedClass`: `Reference constraint of type 'AttributeType' in declaration 'AttributeTargets.Method(int)' (SyntaxKind=IdentifierName).`

// Warning MY001 on `ValidatedClass`: `Reference constraint of type 'AttributeType' in declaration 'AttributeTargets.Method(int)/p' (SyntaxKind=IdentifierName).`
