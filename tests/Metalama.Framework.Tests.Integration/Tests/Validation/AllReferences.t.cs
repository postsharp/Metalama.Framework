...
// Warning MY001 on `ValidatedClass.InstanceField`: `Reference constraint of type 'NameOf' in declaration 'DerivedClass.Method(ValidatedClass[], List<ValidatedClass>)' (SyntaxKind=SimpleMemberAccessExpression).`
