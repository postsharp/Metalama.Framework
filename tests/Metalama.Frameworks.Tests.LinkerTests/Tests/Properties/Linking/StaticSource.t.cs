class Target
{
  ...
  private static int Bar_Override1_1
  {
    get
    {
      ...
      _ = global::Metalama.Framework.Tests.Integration.Tests.Linker.Properties.Linking.StaticSource.Target.Bar_Source;
      // Should invoke source code.
      _ = global::Metalama.Framework.Tests.Integration.Tests.Linker.Properties.Linking.StaticSource.Target.Bar_Source;
    ...
    {
      // Should invoke source code.
      global::Metalama.Framework.Tests.Integration.Tests.Linker.Properties.Linking.StaticSource.Target.Bar_Source = value;
      // Should invoke source code.
      global::Metalama.Framework.Tests.Integration.Tests.Linker.Properties.Linking.StaticSource.Target.Bar_Source = value;
      // Should invoke override 1_2.
