class Target
{
  ...
  private static event System.EventHandler Bar_Source
  {
    add
    {
  ...
  private static event System.EventHandler Bar_Override1_1
  {
    add
    {
      ...
      global::Metalama.Framework.Tests.Integration.Tests.Linker.Events.Linking.StaticSource.Target.Bar_Source += value;
      // Should invoke source code.
      global::Metalama.Framework.Tests.Integration.Tests.Linker.Events.Linking.StaticSource.Target.Bar_Source += value;
