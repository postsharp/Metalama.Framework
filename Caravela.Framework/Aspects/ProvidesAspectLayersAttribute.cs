...
namespace Caravela.Framework.Aspects
{
    ...
    /// to provide advices into different aspect parts by setting the <see cref="IAdvice.LayerName"/> property.
    ...
    public sealed class ProvidesAspectLayersAttribute : Attribute
    {
        ...
        /// </summary>
        /// <param name="layers">An ordered list of aspect parts.</param>
