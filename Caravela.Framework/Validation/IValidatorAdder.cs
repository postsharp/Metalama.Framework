...
namespace Caravela.Framework.Validation
{
    public interface IValidatorAdder
    {
        ...
        void AddReferenceValidator<TTarget, TConstraint>( TTarget targetDeclaration, IReadOnlyList<DeclarationReferenceKind> referenceKinds, IReadOnlyDictionary<string, string>? properties = null )
            where TTarget : IDeclaration
